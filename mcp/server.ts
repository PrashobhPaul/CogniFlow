...
/**
 * CogniFlow MCP server (stdio). Lets Claude, ChatGPT or any MCP client turn a
 * ~50-token architecture description into a validated, animated architecture
 * diagram without spending thousands of tokens drawing SVG: the compiler,
 * classifier, layout and renderers are the same code the studio ships.
 *
